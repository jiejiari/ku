...
export default class MainView extends BaseView {
    ...
    onAwake(): void {
        ...
        this.adPlane = this.owner.getChildByName("ADPanel").getComponent(AdListLoop);
    ...
    showADPanel(){
        (this.owner.getChildByName("ADPanel") as Laya.View).visible = true;
        Laya.timer.frameOnce(2,this,()=>{
            ...
            this.adPlane.start(ConfigData.getAdData(1008),1008,"首页");
        });
    }

    hideADPanel(){
        (this.owner.getChildByName("ADPanel") as Laya.View).visible = false;
    }
    ...
    private ShowBanner(){
        if(!PlatformMgr.callAPIMethodByProxy("showBannerAdHome")){
            this.showADPanel();
        }else{
            this.hideADPanel();
        }
