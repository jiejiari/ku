...
export default class RewardView extends BaseView {
    ...
    onAwake(): void {
        ...
        this.bottom = this.owner.getChildByName("bottom") as Laya.Image;
        this.getBtn = this.bottom.getChildByName("getBtn") as Laya.Image;
...
onClickGet(){
    ...
    if(this.bottom.bottom != 324) return;
    this.OVERhuoquAIn();
     return;
