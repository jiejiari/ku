...
import OverAdListLoop from "./OverAdListLoop";
...
export default class GameOver extends BaseView {
    ...
    onAwake(): void {
        ...
        this.ButtonADPanel.y += this.offset.y / 2;
    ...
    showADPanel(){
        ...
        Laya.timer.frameOnce(2,this,()=>{
            ...
            this.ButtonAdListloop.start(ConfigData.getAdData(1007),1007,"结算页");
        });
    }
    ...
    private ShowBanner(){
        if(PlatformMgr.callAPIMethodByProxy("showBannerAdGameOver")){
            this.hideADPanel();
        }else{
            this.showADPanel();
        }
